...
$headers = array(
  ...
  "30".$cx."Fucking npm","31".$cx."Fucking Rubygems","32".$cx."Fucking Unic💩de","33".$cx."Fucking Deadlocks","34".$cx."Fucking Deferreds","35".$cx."Fucking IE","36".$cx."Fucking Race Conditions","37".$cx."FuckThreading","38".$cx."Fucking Exactly-once Delivery","39".$cx."Fucking Windows",
