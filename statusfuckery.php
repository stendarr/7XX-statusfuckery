...
$headers = array(
  "01".$ox."Meh","02".$ox."Emacs","03".$ox."Explosion","04".$ox."Goto Fail","05".$ox."I wrote the code and missed the necessary validation by an oversight (see 795)",
  "10".$ax."PHP","11".$ax."Convenience Store","12".$ax."NoSQL","18".$ax."Haskell","19".$ax."I am not a teapot",
  "20".$bx."Unpossible","21".$bx."Known Unknowns","22".$bx."Unknown Unknowns","23".$bx."Tricky","24".$bx."This line should be unreachable","25".$bx."It works on my machine","26".$bx."It's a feature, not a bug","27".$bx."32 bits is plenty",
